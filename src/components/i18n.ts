...
export const STRINGS: Record<Lang, Strings> = {
  ja: {
    ...
    estNote: "到着・所要は途中駅からの推定値です",
    selectBoth: "出発と到着を選ぶと、次に乗れる電車が表示されます。",
    sameTitle: "同じ駅です",
    sameBody: "出発と到着に別の駅を選んでください。",
    noneTitle: "経路が見つかりません",
    noneBody: "直通の系統がありません。乗り換えが必要です（乗換案内は今後対応）。",
    suspendedTitle: "本日は運休です",
    suspendedBody: "本町線（⑥番）は土曜・日曜・祝日は終日運休です。これらの駅を結ぶ系統は本町線のみのため、本日は運行していません。",
